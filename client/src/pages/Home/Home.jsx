    ...
    return(
        ...
        <div className="col-span-6 bg-gray-200">
          ...
          <div className="p-4 flex items-center justify-between">
            ...
            <div className="w-1/2">
              {/* Text content */}
              <p>Hello how is it going asjkdhas djkashd jkhasd jkhasdkjd h jaskdhjksdakjdsha  jadshkasjd jkashd jsakdhjaksd</p>
            </div>
          </div>
          ...
          <div className="p-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <p className="text-xl justify-center flex items-center">Nyttig Informasjon</p>
              </div>
              {/* Third Row */}
              <div className="col-span-2">
