        ...
        <div className="grid grid-cols-10 gap-4">
          <div className="col-span-10 md:col-span-7 bg-white-200 px-4">
            ...
            {nyheter && nyheter.slice(0,6).map((nyheter,index) => (
                ...
                <p className="line-clamp-3 overflow-hidden h-18 md:h-auto text-gray-700 dark:text-gray-400" dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(`<span>${nyheter.desc}</span>`) }}></p>
