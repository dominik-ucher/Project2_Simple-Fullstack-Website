  ...
  "node_modules/quill-better-table/dist/quill-better-table.js"(exports, module) {
    (function webpackUniversalModuleDefinition(root, factory) {
      if (typeof exports === "object" && typeof module === "object")
        ...
        exports["quillBetterTable"] = factory(require_quill());
      else
          ...
          function hotApply(options) {
            ...
            function getAffectedStuff(updateModuleId) {
              ...
              while (queue2.length > 0) {
                ...
                if (!module2 || module2.hot._selfAccepted)
                  continue;
            ...
            class header_Header extends Block {
              static create(value) {
                ...
                CELL_IDENTITY_KEYS.forEach((key) => {
                  if (value[key])
                    node.setAttribute("data-".concat(key), value[key]);
                });
            ...
            class table_selection_TableSelection {
              ...
              mouseDownHandler(e) {
                ...
                function mouseMoveHandler(e2) {
                  if (e2.button !== 0 || !e2.target.closest(".quill-better-table"))
                    return;
