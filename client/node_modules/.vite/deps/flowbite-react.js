import {
  ...
  HiSun,
  HiX
} from "./chunk-3AAMEGII.js";
import {
  FaBars
} from "./chunk-AQ5JOHZA.js";
import {
  require_react_dom
} from "./chunk-QMINRHT5.js";
import "./chunk-CKPX2XIV.js";
import {
  require_jsx_runtime
...
var Badge = ({ children, color = "info", href, icon: Icon, size: size3 = "xs", className, theme: customTheme = {}, ...props }) => {
  ...
  const Content = () => (0, import_jsx_runtime9.jsxs)("span", { className: twMerge(theme2.root.base, theme2.root.color[color], theme2.icon[Icon ? "on" : "off"], theme2.root.size[size3], className), "data-testid": "flowbite-badge", ...props, children: [Icon && (0, import_jsx_runtime9.jsx)(Icon, { "aria-hidden": true, className: theme2.icon.size[size3], "data-testid": "flowbite-badge-icon" }), children && (0, import_jsx_runtime9.jsx)("span", { children })] });
...
var Trigger = ({ refs, children, inline: inline3, theme: theme2, disabled, setButtonWidth, getReferenceProps, renderTrigger, ...buttonProps }) => {
  ...
  return inline3 ? (0, import_jsx_runtime22.jsx)("button", { type: "button", ref: refs.setReference, className: theme2 == null ? void 0 : theme2.inlineWrapper, disabled, ...a11yProps, children }) : (0, import_jsx_runtime22.jsx)(Button, { ...buttonProps, disabled, type: "button", ref: refs.setReference, ...a11yProps, children });
};
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime39.jsxs)("div", { className: twMerge(theme2.base, popup && theme2.popup, className), ...props, children: [(0, import_jsx_runtime39.jsx)(Component, { className: theme2.title, children }), (0, import_jsx_runtime39.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime39.jsx)(HiOutlineX, { "aria-hidden": true, className: theme2.close.icon }) })] });
};

// node_modules/flowbite-react/lib/esm/components/Modal/Modal.js
var ModalComponent = ({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size3 = "2xl", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_react_dom4.createPortal)((0, import_jsx_runtime40.jsx)(ModalContext.Provider, { value: { popup, onClose }, children: (0, import_jsx_runtime40.jsx)("div", { "aria-hidden": !show, "data-testid": "modal", onClick: handleOnClick, role: "dialog", className: twMerge(theme2.root.base, theme2.root.positions[position], show ? theme2.root.show.on : theme2.root.show.off, className), ...props, children: (0, import_jsx_runtime40.jsx)("div", { className: twMerge(theme2.content.base, theme2.root.sizes[size3]), children: (0, import_jsx_runtime40.jsx)("div", { className: theme2.content.inner, children }) }) }) }), containerRef.current);
};
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  const { size: size3 = "sm" } = useRatingContext();
  const theme2 = mergeDeep(useTheme().theme.rating.star, customTheme);
  return (0, import_jsx_runtime52.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: twMerge(theme2.sizes[size3], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size3 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime53.jsx)(RatingContext.Provider, { value: { size: size3 }, children: (0, import_jsx_runtime53.jsx)("div", { className: twMerge(theme2.root.base, className), ...props, children }) });
};
...
var TextInput = (0, import_react39.forwardRef)(({ addon, className, color = "gray", helperText, icon: Icon, rightIcon: RightIcon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
...
var Textarea = (0, import_react40.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
...
var ToastComponent = ({ children, className, duration = 300, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime81.jsx)(ToastContext.Provider, { value: { duration, isClosed, isRemoved, setIsClosed, setIsRemoved }, children: (0, import_jsx_runtime81.jsx)("div", { "data-testid": "flowbite-toast", className: twMerge(theme2.root.base, durationClasses[duration], isClosed && theme2.root.closed, isRemoved && theme2.root.removed, className), ...props, children }) });
};
